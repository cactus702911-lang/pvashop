    ...
    <div className="flex flex-col min-h-screen overflow-x-hidden font-sans">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {home.services.map((service, index) => (
              ...
              >
                ...
                <Link to={service.link || "/shop"} className="inline-flex items-center gap-2 text-slate-900 font-bold group-hover:text-blue-600 transition-colors">
              ...
              >
                ...
                <div className="flex items-center gap-4 pt-6 border-t border-slate-700">
                  <div className={`p-1 rounded-full bg-gradient-to-br from-blue-500 to-purple-500`}>
                    <img src={testimonial.image} alt={testimonial.author} className="w-12 h-12 rounded-full border-2 border-slate-900 object-cover" />
                  </div>
                  <div>
      ...
      <section className="py-24 relative overflow-hidden bg-blue-600">
        <div className="absolute inset-0">
          ...
          <div className="absolute -top-[500px] -right-[500px] w-[1000px] h-[1000px] bg-white rounded-full blur-[150px] opacity-20"></div>
        </div>
        ...
        <div className="container mx-auto px-4 md:px-6 text-center relative z-10">
          <motion.div
             ...
             transition={{ duration: 0.6 }}
          >
            <h2 className="text-4xl md:text-6xl font-bold mb-8 text-white tracking-tight">{home.ctaTitle}</h2>
            <p className="text-blue-100 text-xl max-w-2xl mx-auto mb-12 leading-relaxed font-medium">
              {home.ctaSubtitle}
            </p>
            <Link
              to="/shop"
              className="bg-white text-blue-600 hover:bg-slate-50 px-12 py-5 rounded-xl font-bold text-xl transition-all shadow-2xl hover:shadow-white/20 hover:-translate-y-1 inline-flex items-center gap-2"
            >
              {home.ctaButton} <ArrowRight className="w-6 h-6" />
            </Link>
          </motion.div>
        </div>
      </section>
