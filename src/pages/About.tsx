...
import { ShieldCheck, Truck, Headphones, Award, CheckCircle, Users, Clock, Globe } from 'lucide-react';
    ...
    <div className="pt-20 min-h-screen bg-white">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="md:w-1/2">
              ...
              <div className="flex gap-4">
                ...
                <Link to="/contact" className="text-primary font-bold hover:underline">Get in Touch</Link>
              </div>
            </div>
          </div>
        </div>
         ...
         <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-8">
               <div className="bg-white p-6 rounded-xl shadow-sm w-64">
                  ...
                  <p className="text-slate-500 text-sm">Support Manager</p>
               </div>
               <div className="bg-white p-6 rounded-xl shadow-sm w-64">
                  <div className="w-20 h-20 bg-slate-200 rounded-full mx-auto mb-4 overflow-hidden">
                     <img src="https://randomuser.me/api/portraits/women/44.jpg" alt="Support" className="w-full h-full object-cover" />
                  </div>
                  <h4 className="font-bold text-lg">Sarah Smith</h4>
                  <p className="text-slate-500 text-sm">Sales Executive</p>
               </div>
               <div className="bg-white p-6 rounded-xl shadow-sm w-64">
                  <div className="w-20 h-20 bg-slate-200 rounded-full mx-auto mb-4 overflow-hidden">
                     <img src="https://randomuser.me/api/portraits/men/85.jpg" alt="Support" className="w-full h-full object-cover" />
                  </div>
                  <h4 className="font-bold text-lg">Mike Brown</h4>
                  <p className="text-slate-500 text-sm">Technical Lead</p>
               </div>
            </div>
         </div>
      </section>
      ...
      <section className="py-20 bg-primary text-white text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-6">{about.ctaTitle}</h2>
          <p className="text-blue-100 text-lg max-w-2xl mx-auto mb-10">
            {about.ctaSubtitle}
          </p>
          <Link to="/contact" className="inline-block bg-white text-primary px-8 py-3 rounded-full font-bold hover:bg-slate-100 transition-colors">
            {about.ctaButton}
          </Link>
        </div>
      </section>
